...
3. Add authorised redirect URI: `https://api.yourdomain.com/v1/auth/google/callback`
...
| `GOOGLE_REDIRECT_URL` | `https://api.yourdomain.com/v1/auth/google/callback` |
...
Replace `yourdomain.com` with your actual domain in [infra/Caddyfile](infra/Caddyfile).
